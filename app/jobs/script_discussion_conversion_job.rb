  ...
  def perform(script_id)
    Script.transaction do
      ...
      script.discussions.each do |forum_discussion|
        ...
        new_discussion.save!
        forum_discussion.forum_comments.create!(Body: "This discussion has been migrated to <a href=\"#{new_discussion.url}\"></a>", Format: 'Html', InsertUserID: 1, DateInserted: Time.now)
