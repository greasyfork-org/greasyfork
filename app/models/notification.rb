class Notification < ApplicationRecord
  ...
  enum :notification_type, { NOTIFICATION_TYPE_NEW_CONVERSATION => 0, NOTIFICATION_TYPE_NEW_MESSAGE => 1, NOTIFICATION_TYPE_REPORT_RESOLVED_REPORTER => 2, NOTIFICATION_TYPE_REPORT_FILED_REPORTED => 3, NOTIFICATION_TYPE_REPORT_RESOLVED_REPORTED => 4 }
