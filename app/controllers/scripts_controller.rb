...
class ScriptsController < ApplicationController
  ...
  def user_js
    respond_to do |format|
      format.any(:html, :all, :js) do
        ...
        cache_code_request(user_js_code, script_id:, script_version_id_param:, extension: '.user.js')
  ...
  def user_css
    respond_to do |format|
      format.any(:html, :all, :css) do
        ...
        cache_code_request(user_js_code, script_id:, script_version_id_param:, extension: '.user.css')
  ...
  def cache_code_request(response_body, script_id:, script_version_id_param:, extension:)
    ...
    base_path = if script_version_id_param == 0
                  ...
                  base_path.join('versioned', script_id, "#{script_version_id_param}#{extension}")
                end
