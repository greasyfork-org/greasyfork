...
class UsersController < ApplicationController
  ...
  def update_notification_settings
    User.transaction do
      current_user.update!(params.expect(user: [:subscribe_on_discussion, :subscribe_on_comment, :subscribe_on_script_discussion, :subscribe_on_conversation_starter, :subscribe_on_conversation_receiver]))
      NOTIFICATION_KEYS.each do |notification_key|
