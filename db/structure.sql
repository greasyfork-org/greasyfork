...
CREATE TABLE `GDN_Activity` (
  ...
  `HeadlineFormat` varchar(255) DEFAULT NULL,
...
CREATE TABLE `GDN_ActivityType` (
  ...
  `ProfileHeadline` varchar(255) DEFAULT NULL,
  `FullHeadline` varchar(255) DEFAULT NULL,
...
CREATE TABLE `GDN_Ban` (
  ...
  `BanType` enum('IPAddress','Name','Email') NOT NULL,
  `BanValue` varchar(50) NOT NULL,
...
CREATE TABLE `GDN_Category` (
  ...
  `DisplayAs` enum('Categories','Discussions','Flat','Heading','Default') NOT NULL DEFAULT 'Discussions',
  `InsertUserID` int(11) NOT NULL,
  `UpdateUserID` int(11) DEFAULT NULL,
  `DateInserted` datetime NOT NULL,
  `DateUpdated` datetime NOT NULL,
  ...
  `AllowedDiscussionTypes` varchar(255) DEFAULT NULL,
  `DefaultDiscussionType` varchar(10) DEFAULT NULL,
...
CREATE TABLE `GDN_Conversation` (
  ...
  `ForeignID` varchar(40) DEFAULT NULL,
...
CREATE TABLE `GDN_Discussion` (
  ...
  `Type` varchar(10) DEFAULT NULL,
  `ForeignID` varchar(32) DEFAULT NULL,
...
CREATE TABLE `GDN_Flag` (
  `DiscussionID` int(11) DEFAULT NULL,
  `InsertUserID` int(11) NOT NULL,
  `InsertName` varchar(64) NOT NULL,
  `AuthorID` int(11) NOT NULL,
  `AuthorName` varchar(64) NOT NULL,
  `ForeignURL` varchar(191) NOT NULL,
  `ForeignID` int(11) NOT NULL,
  `ForeignType` varchar(32) NOT NULL,
...
CREATE TABLE `GDN_Log` (
  ...
  `Operation` enum('Delete','Edit','Spam','Moderate','Pending','Ban','Error') NOT NULL,
  `RecordType` enum('Discussion','Comment','User','Registration','Activity','ActivityComment','Configuration','Group','Event') NOT NULL,
  ...
  `DateInserted` datetime NOT NULL,
  `InsertIPAddress` varbinary(16) DEFAULT NULL,
  `OtherUserIDs` varchar(255) DEFAULT NULL,
  `DateUpdated` datetime DEFAULT NULL,
...
CREATE TABLE `GDN_Media` (
  ...
  `StorageMethod` varchar(24) NOT NULL DEFAULT 'local',
  `Path` varchar(255) NOT NULL,
  `InsertUserID` int(11) NOT NULL,
  `DateInserted` datetime NOT NULL,
  `ForeignID` int(11) DEFAULT NULL,
  `ForeignTable` varchar(24) DEFAULT NULL,
  PRIMARY KEY (`MediaID`),
...
CREATE TABLE `GDN_Message` (
  ...
  `AssetTarget` varchar(20) DEFAULT NULL,
...
CREATE TABLE `GDN_Permission` (
  ...
  `JunctionTable` varchar(100) DEFAULT NULL,
  `JunctionColumn` varchar(100) DEFAULT NULL,
...
CREATE TABLE `GDN_Regarding` (
  ...
  `ForeignType` varchar(32) NOT NULL,
  `ForeignID` int(11) NOT NULL,
  `OriginalContent` text DEFAULT NULL,
  `ParentType` varchar(32) DEFAULT NULL,
  `ParentID` int(11) DEFAULT NULL,
  `ForeignURL` varchar(255) DEFAULT NULL,
  `Comment` text NOT NULL,
...
CREATE TABLE `GDN_Role` (
  ...
  `Name` varchar(100) NOT NULL,
  `Description` varchar(500) DEFAULT NULL,
  `Type` enum('guest','unconfirmed','applicant','member','moderator','administrator') DEFAULT NULL,
  `Sort` int(11) DEFAULT NULL,
...
CREATE TABLE `GDN_User` (
  ...
  `DiscoveryText` text DEFAULT NULL,
  ...
  `AllIPAddresses` varchar(100) DEFAULT NULL,
  `DateInserted` datetime NOT NULL,
  `InsertIPAddress` varbinary(16) DEFAULT NULL,
  `DateUpdated` datetime DEFAULT NULL,
  `UpdateIPAddress` varbinary(16) DEFAULT NULL,
...
CREATE TABLE `GDN_UserAuthentication` (
  `ForeignUserKey` varchar(100) NOT NULL,
...
CREATE TABLE `GDN_UserAuthenticationProvider` (
  ...
  `AssociationSecret` text DEFAULT NULL,
  `AssociationHashMethod` varchar(20) DEFAULT NULL,
  `AuthenticateUrl` varchar(255) DEFAULT NULL,
  `RegisterUrl` varchar(255) DEFAULT NULL,
  `SignInUrl` varchar(255) DEFAULT NULL,
  `SignOutUrl` varchar(255) DEFAULT NULL,
  `PasswordUrl` varchar(255) DEFAULT NULL,
...
CREATE TABLE `GDN_UserAuthenticationToken` (
  ...
  `ForeignUserKey` varchar(100) DEFAULT NULL,
...
CREATE TABLE `GDN_UserPoints` (
  `SlotType` enum('d','w','m','y','a') NOT NULL,
  `TimeSlot` datetime NOT NULL,
  `Source` varchar(10) NOT NULL DEFAULT 'Total',
...
) ENGINE=InnoDB AUTO_INCREMENT=451112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119342 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=57816 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `akismet_submissions` (
  ...
  `akismet_params` mediumtext NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=179399 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=164467 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=55366 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=434081 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=429715 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13442 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13823 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=510198437 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7707729 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=203095 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=401438 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20647437 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=801604 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locales` (
  ...
  `detect_language_code` varchar(20) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=633827 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mentions` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `mentioning_item_type` varchar(255) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=655244 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  `content_markup` varchar(10) NOT NULL DEFAULT 'html',
  `edited_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=20258 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93018 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reports` (
  ...
  `auto_reporter` varchar(10) DEFAULT NULL,
  `explanation_markup` varchar(10) NOT NULL DEFAULT 'html',
  ...
  `self_upheld` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=50276 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1046772 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1365402 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `script_lock_appeals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `script_lock_appeals` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `script_id` int(11) NOT NULL,
  `report_id` bigint(20) DEFAULT NULL,
  `text` text NOT NULL,
  ...
  `moderator_notes` text DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_rails_b37644914a` (`script_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=972094 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1608 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `script_sets` (
  ...
  `default_sort` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=588704 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `script_similarities` (
  ...
  `tersed` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `script_similarity_search` (`script_id`,`other_script_id`,`tersed`),
...
) ENGINE=InnoDB AUTO_INCREMENT=109987301 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `script_subresource_usages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `script_subresource_usages` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=49608 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `script_versions` (
  ...
  `changelog_markup` varchar(10) NOT NULL DEFAULT 'text',
...
) ENGINE=InnoDB AUTO_INCREMENT=1254861 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scripts` (
  ...
  `sync_identifier` varchar(500) DEFAULT NULL,
  `sync_error` varchar(1000) DEFAULT NULL,
  `last_attempted_sync_date` datetime DEFAULT NULL,
  `last_successful_sync_date` datetime DEFAULT NULL,
  `delta` tinyint(1) NOT NULL DEFAULT 1,
  `license_text` varchar(500) DEFAULT NULL,
  ...
  `contribution_url` varchar(255) DEFAULT NULL,
  `contribution_amount` varchar(255) DEFAULT NULL,
  ...
  `language` varchar(3) NOT NULL DEFAULT 'js',
  `css_convertible_to_js` tinyint(1) NOT NULL DEFAULT 0,
  `not_js_convertible_override` tinyint(1) NOT NULL DEFAULT 0,
  `review_state` varchar(255) NOT NULL DEFAULT 'not_required',
  `deleted_at` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=475922 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `site_applications` (
  ...
  `blocked_message` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=103138 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subresources` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_subresources_on_url` (`url`) USING HASH
) ENGINE=InnoDB AUTO_INCREMENT=11522 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=91663309 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `reset_password_token` varchar(150) DEFAULT NULL,
  ...
  `profile_markup` varchar(10) NOT NULL DEFAULT 'html',
  ...
  `preferred_markup` varchar(10) NOT NULL DEFAULT 'html',
  `show_sensitive` tinyint(1) DEFAULT 0,
  `delete_confirmation_key` varchar(255) DEFAULT NULL,
  ...
  `announcements_seen` varchar(255) DEFAULT NULL,
  ...
  `notify_as_reporter` tinyint(1) NOT NULL DEFAULT 1,
  `notify_as_reported` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1179004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
