...
ActiveRecord::Schema[7.0].define(version: 2023_11_12_225004) do
  create_table "GDN_AccessToken", primary_key: "AccessTokenID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Activity", primary_key: "ActivityID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_ActivityComment", primary_key: "ActivityCommentID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_ActivityType", primary_key: "ActivityTypeID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_AnalyticsLocal", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Attachment", primary_key: "AttachmentID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Ban", primary_key: "BanID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Category", primary_key: "CategoryID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Conversation", primary_key: "ConversationID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_ConversationMessage", primary_key: "MessageID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Draft", primary_key: "DraftID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Flag", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "DiscussionID"
    t.integer "InsertUserID", null: false
  ...
  create_table "GDN_Invitation", primary_key: "InvitationID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Log", primary_key: "LogID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Media", primary_key: "MediaID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "Name", null: false
  ...
  create_table "GDN_Message", primary_key: "MessageID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Permission", primary_key: "PermissionID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Photo", primary_key: "PhotoID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "Name", null: false
    t.integer "InsertUserID"
    t.datetime "DateInserted", precision: nil, null: false
  ...
  create_table "GDN_Regarding", primary_key: "RegardingID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Role", primary_key: "RoleID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "Name", limit: 100, null: false
    t.string "Description", limit: 500
  ...
  create_table "GDN_Session", primary_key: "SessionID", id: { type: :string, limit: 32 }, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Spammer", primary_key: "UserID", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_Tag", primary_key: "TagID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "Name", limit: 100, null: false
  ...
  create_table "GDN_TagDiscussion", primary_key: ["TagID", "DiscussionID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_User", primary_key: "UserID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserAuthentication", primary_key: ["ForeignUserKey", "ProviderKey"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserAuthenticationNonce", primary_key: "Nonce", id: { type: :string, limit: 100 }, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserAuthenticationProvider", primary_key: "AuthenticationKey", id: { type: :string, limit: 64 }, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserAuthenticationToken", primary_key: ["Token", "ProviderKey"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "Token", limit: 128, null: false
  ...
  create_table "GDN_UserCategory", primary_key: ["UserID", "CategoryID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
    t.integer "CategoryID", null: false
    t.datetime "DateMarkedRead", precision: nil
  ...
  create_table "GDN_UserComment", primary_key: ["UserID", "CommentID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
  ...
  create_table "GDN_UserConversation", primary_key: ["UserID", "ConversationID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
    t.integer "ConversationID", null: false
  ...
  create_table "GDN_UserDiscussion", primary_key: ["UserID", "DiscussionID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
    t.integer "DiscussionID", null: false
    t.float "Score"
    t.integer "CountComments", default: 0, null: false
  ...
  create_table "GDN_UserIP", primary_key: ["UserID", "IPAddress"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
  ...
  create_table "GDN_UserMerge", primary_key: "MergeID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserMergeItem", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserMeta", primary_key: ["UserID", "Name"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
    t.string "Name", limit: 100, null: false
    t.text "Value"
  ...
  create_table "GDN_UserPoints", primary_key: ["SlotType", "TimeSlot", "Source", "CategoryID", "UserID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_UserRole", primary_key: ["UserID", "RoleID"], charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "UserID", null: false
    t.integer "RoleID", null: false
    t.index ["RoleID"], name: "IX_UserRole_RoleID"
  end

  create_table "GDN_contentDraft", primary_key: "draftID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_reaction", primary_key: "reactionID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "GDN_reactionOwner", primary_key: "reactionOwnerID", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
