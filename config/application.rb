...
module Greasyfork
  class Application < Rails::Application
    ...
    config.available_locales = {'bg' => 'Български', 'de' => 'Deutsch', 'en' => 'English', 'es' => 'Español', 'fr' => 'Français', 'id' => 'Bahasa Indonesia', 'ja' => '日本語', 'nl' => 'Nederlands', 'pl' => 'Polski', 'pt-BR' => 'Português do Brasil', 'ru' => 'Русский', 'zh-CN' => '简体中文', 'zh-TW' => '繁體中文'}
