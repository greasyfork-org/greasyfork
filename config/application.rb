...
module Greasyfork
  class Application < Rails::Application
    ...
    config.available_locales = {'ar' => 'العَرَبِيةُ', 'bg' => 'Български', 'cs' => 'Čeština', 'de' => 'Deutsch', 'el' => 'Ελληνικά', 'en' => 'English', 'es' => 'Español', 'fr' => 'Français', 'fr-CA' => 'Français canadien', 'id' => 'Bahasa Indonesia', 'it' => 'Italiano', 'ja' => '日本語', 'nl' => 'Nederlands', 'pl' => 'Polski', 'pt-BR' => 'Português do Brasil', 'ru' => 'Русский', 'tr' => 'Türkçe', 'uk' => 'Українська', 'vi' => 'Tiếng Việt', 'zh-CN' => '简体中文', 'zh-TW' => '繁體中文'}
