...
Rails.application.routes.draw do
  ...
  scope '(:locale)', locale: /ar|bg|cs|da|de|el|en|es|fi|fr|fr-CA|he|hu|id|it|ja|ko|nb|nl|eo|pl|pt-BR|ro|ru|sk|sr|sv|th|tr|uk|ug|vi|zh-CN|zh-TW/ do
    ...
    resources :discussions, path: 'discussions/:category', category: /greasyfork|development|requests|script-discussions|no-scripts/, only: [:index, :show, :destroy], as: 'category_discussion' do
      member do
        post :subscribe
        post :unsubscribe
      end
