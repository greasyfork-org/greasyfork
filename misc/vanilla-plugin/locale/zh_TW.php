...
$Definition['RatingReport'] = '舉報該腳本并通知管理員移除 - 惡意代碼或抄襲代碼等情形。';
/** Label for the radio button for rating a script "Bad" */
$Definition['RatingBad'] = '差評 - 腳本用不了或已經無效';
...
$Definition['Categories.general.Name'] = '站點反饋';
// Category description for Site Feedback
$Definition['Categories.general.Description'] = '關於 Greasy Fork 網站自身的錯誤報告、功能請求或其它內容。';
// Category name for Development
$Definition['Categories.script-development.Name'] = '腳本開發';
// Category description for Development
$Definition['Categories.script-development.Description'] = '關於腳本開發的一些技術性質的討論。';
// Category name for Script Creation Requests
$Definition['Categories.script-requests.Name'] = '腳本建立請求';
// Category description for Script Creation Requests
$Definition['Categories.script-requests.Description'] = '請求其他人幫您撰寫一個腳本';
// Category name for Script Discussions
$Definition['Categories.script-discussions.Name'] = '腳本討論';
// Category description for Script Discussions
$Definition['Categories.script-discussions.Description'] = '對 Greasy Fork 上的一個腳本進行討論';
// Link on Recent Discussions to hide script discussions
$Definition['Turn on filter'] = '隱藏腳本討論貼';
// Link on Recent Discussions to show script discussions
$Definition['Turn off filter'] = '顯示腳本討論貼';
// Link on forum profile pointing to main site profile
$Definition['Greasy Fork Profile'] = 'Greasy Fork 上的個人資料';
