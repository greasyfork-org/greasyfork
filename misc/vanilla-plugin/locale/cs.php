...
$Definition['on scripts by %s'] = 'u skriptů od uživatele %s';
/*
 *  Label for the radio buttons for rating a script
 **/
$Definition['RatingLabel'] = 'Jak byste ohodnotili tento skript?';
# Label for the radio buttons for updating a rating on a script
$Definition['RatingUpdateLabel'] = 'Upravit hodnocení:';
...
$Definition['RatingReport'] = 'Navrhnout moderátorům smazání skriptu - malware, odcizený kód apod.';
...
$Definition['Turn off filter'] = 'Zobrazit diskuse o skriptech';
